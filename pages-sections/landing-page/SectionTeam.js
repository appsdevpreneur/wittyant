...
import teamStyle from "/styles/jss/witty-ant/pages/landingPageSections/teamStyle.js";
              ...
              <GridContainer>
                ...
                <GridItem xs={12} sm={7} md={7}>
                  <CardBody plain>
                    ...
                    <Muted>
                      <h6 className={classes.cardCategory}>UI/UX , Full Stack Developer</h6>
                    </Muted>
              ...
              <GridContainer>
                ...
                <GridItem xs={12} sm={7} md={7}>
                  <CardBody plain>
                    ...
                    <Muted>
                      <h6 className={classes.cardCategory}>GRAPHIC DESIGNER , MERN Stack Developer</h6>
                    </Muted>
                    <p className={classes.description}>
                      Don{"'"}t be scared of the truth because we need to
                      restart the human foundation in truth...
